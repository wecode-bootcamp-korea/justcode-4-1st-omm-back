/*
  ...
  - Added the required column `is_main` to the `masters_categories` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `masters_categories` DROP COLUMN `request_form_id`,
    ADD COLUMN `is_main` BOOLEAN NOT NULL,
